...
public:
    static void DesenharParede() {
        ...
        for (size_t i = 0; i < 9; i++)
        {
            ...
            glVertex2d(x[i], distanciaMapa);
            glVertex2d(x[i], distanciaMapa + 800);
            glVertex2d(400, distanciaMapa + 800);
            glVertex2d(400, distanciaMapa);
    ...
    void desenhar() {
        ...
        translMapa += 1;
        //if ((distanciaMapa - translMapa) <= 400) {
